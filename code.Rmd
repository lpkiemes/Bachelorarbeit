...
ggplot(data = summary_allbus, aes(x = split, y = Y)) +
  ...
  labs(
    title = "Einstellung gegenüber Immigration nach Befragungsmodus",
    subtitle = "Arithmetisches Mittel und Konfidenzintervall in Schwarz",
...
```{r coef names}
coef_names <- rev(c("SD-Wahrnehmung",
                    "SD-Neigung",
                    "CAPI:Interviewer*in-Abitur",
                    "CAPI:Erfahrung",
                    "CAPI:Altersdifferenz",
                    "CAPI:Interviewer*in-Mann",
                    "Interviewer*in-Abitur",
                    "Erfahrung",
                    "Altersdifferenz",
                    "Interviewer*in-Mann",
                    "CAPI:Frau",
...
`r modelsummary::modelsummary(list(m1.lm, m2.lm, m3.lm, m4.lm), coef_rename = coef_names, stars = T, output = "markdown", statistic = 'p.value')`
...
modelsummary::modelsummary(list(m1.lm, m2.lm, m3.lm, m4.lm), 
                           ...
                           stars = T, 
                           statistic = "p.value", 
                           output = here::here("tables", "regression.csv"))
...
df <- allbus2006 %>%
  mutate(
    below_median = ifelse(int_agediff < median(int_agediff), "Unter Median", "Über Median"),
    quantile_group = cut(
      include.lowest = TRUE,
      int_agediff, 
...
df %>% 
  ...
  labs(subtitle = "Haupteffekt in blau",
       title = "Effekt der Altersdifferenz auf Einstellungen gegenüber Immigration",
       colour = "Median Altersdifferenz",
       y = "Einstellung gegenüber Immigration",
       caption = "Daten: ALLBUS 2006") +
  theme(axis.title.x = element_blank()) +
...
df <- allbus2006 %>%
  mutate(
    below_median = ifelse(int_exp < median(int_exp), "Unter Median", "Über Median"),
    quantile_group = cut(
      include.lowest = TRUE,
      int_exp, 
...
df %>% 
  ...
  labs(subtitle = "Haupteffekt in blau",
       title = "Effekt der Erfahrung Interviewer*in auf Einstellungen gegenüber Immigration",
       colour = "Median Erfahrung Interviewer*in",
       y = "Einstellung gegenüber Immigration",
       caption = "Daten: ALLBUS 2006") +
...
df <- allbus2006 %>%
  mutate(
    below_median = ifelse(age < median(age), "Unter Median", "Über Median"),
    quantile_group = cut(
      age, 
...
df %>% 
  ...
  labs(subtitle = "Haupteffekt in blau",
       title = "Effekt des Alters auf Einstellungen gegenüber Immigration",
       colour = "Median Alter",
       y = "Einstellung gegenüber Immigration",
       caption = "Daten: ALLBUS 2006") +
  ggthemes::scale_color_colorblind()
...
df <- allbus2006 %>%
  mutate(
    below_median = ifelse(sdperception < median(sdperception), "Unter Median", "Über Median"),
    quantile_group = cut(
      sdperception, 
...
df %>% 
  ...
  labs(subtitle = "Haupteffekt in blau",
       title = "Effekt der SD-Wahrnehmung auf Einstellungen gegenüber Immigration",
       colour = "Median SD-Wahrnehmung",
       y = "Einstellung gegenüber Immigration",
       caption = "Daten: ALLBUS 2006") +
  ggthemes::scale_color_colorblind()
```
...
df <- allbus2006 %>%
  mutate(
    below_median = ifelse(sdtendency < median(sdtendency), "Unter Median", "Über Median"),
    quantile_group = cut(
      sdperception, 
...
df %>% 
  ...
  labs(subtitle = "Haupteffekt in blau",
       title = "Effekt der SD-Neigung auf Einstellungen gegenüber Immigration",
       colour = "Median SD-Neigung",
       y = "Einstellung gegenüber Immigration",
       caption = "Daten: ALLBUS 2006") +
  ggthemes::scale_color_colorblind()
```
...
```
` r modelsummary::modelsummary(list(m1_nohilfe.lm, m2_nohilfe.lm, m3_nohilfe.lm, m4_nohilfe.lm), coef_rename = coef_names, stars = T, output = "markdown", statistic = 'p.value') `

```{r modelsummary_nohilfe}
modelsummary::modelsummary(list(m1_nohilfe.lm, m2_nohilfe.lm, m3_nohilfe.lm, m4_nohilfe.lm), 
                           coef_rename = coef_names, 
                           stars = T, 
                           statistic = "p.value")
