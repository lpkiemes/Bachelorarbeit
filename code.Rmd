...
pacman::p_load(haven, readr, tidyverse, gtsummary, ggsci, ROSE, labelled, matrixStats, car, psych, lsr, modelsummary, olsrr)
...
ggplot2::ggsave(here::here("plots", "boxplot.png"))
...
m4.lm <- lm(immigration ~ split + age_cen + age_cen * split + edu + edu * split + sex + sex * split + int_sexdiff +
                                     int_sexdiff * split + int_agediff + int_agediff * split + int_agecen + int_agecen * split + sdtendency + sdperception, data = allbus2006)
...
```{r m3_nohilfe}
m3_nohilfe.lm <- lm(immigration ~ split + age_cen + age_cen * split + edu + edu * split + sex + sex * split + int_sexdiff +
                                     int_sexdiff * split + int_agediff + int_agediff * split + int_agecen + int_agecen * split, data = allbus2006_nohilfe)

summary(m3_nohilfe.lm)
```

```{r m4_nohilfe}
m4_nohilfe.lm <- lm(immigration ~ split + age_cen + age_cen * split + edu + edu * split + sex + sex * split + int_sexdiff +
                                     int_sexdiff * split + int_agediff + int_agediff * split + int_agecen + int_agecen * split + sdtendency + sdperception, data = allbus2006_nohilfe)
