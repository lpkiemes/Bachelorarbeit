...
# as line 25-30 in data/ZA4500_patch_v2-0-0.do

allbus2006 <- allbus2006 |> 
  mutate(
    v736 = ifelse(v736 %in% c(8:10), NA, v736),
    v738 = ifelse(v738 %in% c(8:10), NA, v738),
    interviewer_male = ifelse(v702 == 2, 0, v702),
    interviewer_age = v703,
    interviewer_agediff = ifelse(v703 == 999, NA, v703),
    interviewer_agediff = abs(v703 - v27),
